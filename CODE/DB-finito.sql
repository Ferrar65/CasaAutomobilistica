...
--
-- Host: 127.0.0.1
-- Creato il: Mag 24, 2021 alle 22:09
...
INSERT INTO `veicolo` (`targa`, `annoImmatricolazione`, `cilindrata`, `alimentazione`, `prezzo`, `colore`, `numPorte`, `note`, `modello`) VALUES
...
--
-- Dump dei dati per la tabella `vendere`
--

INSERT INTO `vendere` (`veicolo`, `venditore`, `dataInserimento`, `dataVendita`) VALUES
('GK555RE', 423460, '2021-05-12', NULL),
('HG013LC', 256609, '2021-05-16', '2021-05-18'),
('HO436PQ', 889008, '2021-05-09', NULL),
('JJ007JB', 405243, '2021-05-15', '2021-05-18'),
('JK576QW', 405243, '2020-04-13', NULL),
('JS995HT', 256609, '2021-01-11', NULL),
('KZ035CX', 127887, '2017-05-10', NULL),
('LA333SF', 423460, '2018-09-19', NULL),
('LF164GD', 889008, '2020-02-16', '2021-02-27'),
('LG242CC', 423460, '2021-01-10', '2021-04-14'),
('LY457PC', 127887, '2019-11-26', NULL),
('MM454JK', 405243, '2019-05-20', '2020-01-21'),
('MV402OA', 256609, '2020-09-14', '2020-12-15'),
('NE245PK', 405243, '2020-03-16', NULL),
('QQ349PL', 405243, '2021-03-01', '2021-03-17'),
('RC997GA', 127887, '2020-07-14', '2021-01-19'),
('RQ989AB', 423460, '2020-02-04', NULL),
('RT005FG', 256609, '2020-12-10', NULL),
('RY068LL', 405243, '2016-07-17', '2018-09-08'),
('SB204LE', 889008, '2018-08-12', NULL),
('SF202CA', 256609, '2016-05-11', '2017-09-10'),
('TP445YP', 405243, '2019-07-07', '2019-10-13'),
('TT909HF', 256609, '2019-08-06', NULL),
('UI003LA', 256609, '2017-05-03', '2019-08-19'),
('UT333HF', 423460, '2020-06-01', '2021-01-13'),
('VC266LC', 256609, '2018-08-08', '2020-04-07'),
('VD245LL', 256609, '2016-05-10', '2018-01-04'),
('VV567CA', 127887, '2019-03-27', NULL),
('WE456TG', 889008, '2017-09-30', '2020-06-16'),
('YT606BG', 405243, '2021-04-13', NULL),
('YY867ZZ', 423460, '2021-01-03', NULL),
('ZF444AA', 405243, '2021-01-11', '2021-04-22'),
('ZF678CT', 127887, '2019-04-15', NULL),
('ZG932SS', 889008, '2021-03-07', NULL),
('ZZ999ZZ', 405243, '2018-09-25', '2019-08-27');
...
INSERT INTO `venditore` (`idVenditore`, `tipoVenditore`, `nome`, `cognome`, `codFiscale`, `ragioneSociale`, `pIVA`, `telefono`) VALUES
(127887, 'esperto', 'Jasmine', 'Botton', 'BTTJMN12B08B035I', 'Jasmine S.r.l', '89085593523', '3519009976'),
(256609, 'principiante', 'Pino', 'Quarto', 'QRTPNI01B53E374R', 'Pino S.r.l', '12524478312', '3519001242'),
(405243, 'principiante', 'Bob', 'Marley', 'MRLBOB69Y14A111B', 'Bobby S.r.l', '96324853923', '3519005556'),
(423460, 'esperto', 'Azzurro', 'Bergamelli', 'BNPGLL15H58D390Z', 'Azzurro S.r.l', '45554212340', '3205420129'),
(889008, 'esperto', 'Sean', 'Williams', 'WLLSNE80A19D390L', 'Sean S.r.l', '56778456740', '3205453467');
