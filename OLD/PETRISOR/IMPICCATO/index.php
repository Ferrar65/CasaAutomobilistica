         ...
         <div align="center">
            <div class="row">
               <div class="col welcome__button welcome__button--right">
                  <form action="/IMPICCATO/venditaVeicoli/index.php" method="post">
                    <br><br><button  class="btn btn-primary btn-lg active" role="button" aria-pressed="true" type="submit" name="submit" value="res" >Veicoli in Vendita</button> <!--bottone per tornare alla pagina iniziale-->
                  </form>
               </div>
            </div>
         </div>
